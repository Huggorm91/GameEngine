...
namespace Crimson
{
	...
	template <typename T>
	bool IntersectionAABBAABB(const AABB3D<T>& aBoxA, const AABB3D<T>& aBoxB, Crimson::Vector3<float>& outCollisionNormal, float& outIntersectionDepth);
...
#define RIGHT	2
	...
	bool IntersectionAABBAABB(const AABB3D<T>& aBoxA, const AABB3D<T>& aBoxB, Crimson::Vector3<float>& outCollisionNormal, float& outIntersectionDepth)
	{
		Crimson::Vector3<float> faces[6] =
		{
			 Crimson::Vector3<float>(-1, 0,  0),
			 Crimson::Vector3<float>(1,  0,  0),
			 Crimson::Vector3<float>(0,  -1, 0),
			 Crimson::Vector3<float>(0,  1,  0),
			 Crimson::Vector3<float>(0,  0,  -1),
			 Crimson::Vector3<float>(0,  0,  1),
		};

...
namespace CommonUtilities
{
	...
	{
		CommonUtilities::Vector2<double> newXBasis(cos(aRotation), -sin(aRotation));
		CommonUtilities::Vector2<double> newYBasis(sin(aRotation), cos(aRotation));
	...
	{
		CommonUtilities::Vector2<float> newXBasis(cos(aRotation), -sin(aRotation));
		CommonUtilities::Vector2<float> newYBasis(sin(aRotation), cos(aRotation));
	...
	{
		return Vector2<T>(CommonUtilities::Abs(x), CommonUtilities::Abs(y));
	}
	...
	{
		return Vector2<T>(CommonUtilities::Clamp(x, aMin, aMax),
	...
	{
		return Vector2<T>(CommonUtilities::Clamp(x, aMin.x, aMax.x),
	...
	{
		return Vector2<T>(CommonUtilities::Lerp(aFrom.x, aTo.x, aPercentage),

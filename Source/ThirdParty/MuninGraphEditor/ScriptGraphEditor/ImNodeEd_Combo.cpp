...
bool ImNodeEd::BeginNodeCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    if (ImGuiWindow* popup_window = FindWindowByName(name))
    {
        if (popup_window->WasActive)
        {
            ...
            ImRect frame_bb_screen = ImRect{ ax::NodeEditor::CanvasToScreen(frame_bb.Min), ax::NodeEditor::CanvasToScreen(frame_bb.Max) };

...
void LineHandle::SetActive(bool aValue) const
{
	if (aValue)
	{
		GraphicsEngine::Get().GetLineDrawer().ActivateHandle(*this);
...
void LineHandle::UpdateTransform(const Crimson::Matrix4x4f& aTransform) const
{
...
void LineDrawer::UpdatePrimitiveColor(const LineHandle& aHandle, const Crimson::Vector4f& aColor)
{
...
LineHandle LineDrawer::AddLine(const Crimson::Vector3f& aFrom, const Crimson::Vector3f& aTo, const Crimson::Vector4f& aColor, const Crimson::Matrix4x4f& aTransform, bool aIsUI, LineHandle* aHandle)
{

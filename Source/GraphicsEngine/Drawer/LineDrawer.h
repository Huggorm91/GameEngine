...
public:
	...
	LineHandle AddCube(const Crimson::Vector3f& aCenter, const Crimson::Vector3f& anExtent, const Crimson::Vector4f& aColor = ColorManager::GetColor("White"), const Crimson::Matrix4x4f& aTransform = Crimson::Matrix4x4f::Null, bool aIsUI = false, LineHandle* aHandle = nullptr);

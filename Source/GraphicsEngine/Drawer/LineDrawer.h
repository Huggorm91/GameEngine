#pragma once
#include "GraphicsEngine/Rendering/LineVertex.h"
...
public:
	...
	LineHandle AddLine(const Crimson::Vector3f& aFrom, const Crimson::Vector3f& aTo, const Crimson::Vector4f& aColor = ColorManager::GetColor("White"), const Crimson::Matrix4x4f& aTransform = Crimson::Matrix4x4f::Identity, bool aIsUI = false, LineHandle* aHandle = nullptr);
	...
	LineHandle AddCube(const Crimson::Vector3f& aCenter, const Crimson::Vector3f& anExtent, const Crimson::Vector4f& aColor = ColorManager::GetColor("White"), const Crimson::Matrix4x4f& aTransform = Crimson::Matrix4x4f::Identity, bool aIsUI = false, LineHandle* aHandle = nullptr);
	...
	void UpdatePrimitiveColor(const LineHandle& aHandle, const Crimson::Vector4f& aColor);

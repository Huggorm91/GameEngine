...
LineVertex::LineVertex(): myPosition(0.f, 0.f, 0.f, 1.f), myColor(), myThickness()
{
}

LineVertex::LineVertex(float aX, float aY, float aZ, float aR, float aG, float aB): myPosition(aX, aY, aZ, 1.f), myColor(aR, aG, aB, 1.f), myThickness()
{
}

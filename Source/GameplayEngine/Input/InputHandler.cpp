...
void InputHandler::CreateMouseMoveEvent(const Crimson::Vector2i& aPosition)
{
...
bool InputHandler::UpdateMouseEvents(UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDOWN:
	{
		CreateKeyEvent(static_cast<int>(Crimson::eKey::MouseLeftButton), true);
		return true;
	}
	case WM_LBUTTONUP:
	{
		CreateKeyEvent(static_cast<int>(Crimson::eKey::MouseLeftButton), false);
		return true;
	}
	case WM_LBUTTONDBLCLK:
	{
		CreateDoubleClickEvent(static_cast<int>(Crimson::eKey::MouseLeftButton));
		return true;
	}
	case WM_RBUTTONDOWN:
	{
		CreateKeyEvent(static_cast<int>(Crimson::eKey::MouseRightButton), true);
		return true;
	}
	case WM_RBUTTONUP:
	{
		CreateKeyEvent(static_cast<int>(Crimson::eKey::MouseRightButton), false);
		return true;
	}
	case WM_RBUTTONDBLCLK:
	{
		CreateDoubleClickEvent(static_cast<int>(Crimson::eKey::MouseRightButton));
		return true;
	}
	case WM_MBUTTONDOWN:
	{
		CreateKeyEvent(static_cast<int>(Crimson::eKey::MouseMiddleButton), true);
		return true;
	}
	case WM_MBUTTONUP:
	{
		CreateKeyEvent(static_cast<int>(Crimson::eKey::MouseMiddleButton), false);
		return true;
	}
	case WM_MBUTTONDBLCLK:
	{
		CreateDoubleClickEvent(static_cast<int>(Crimson::eKey::MouseMiddleButton));
		return true;
	}
	case WM_XBUTTONDOWN:
	{
		...
		{
			CreateKeyEvent(static_cast<int>(Crimson::eKey::MouseXButton1), true);
		}
		else
		{
			CreateKeyEvent(static_cast<int>(Crimson::eKey::MouseXButton2), true);
		}
		return true;
	}
	case WM_XBUTTONUP:
	{
		if (GET_XBUTTON_WPARAM(wParam) == XBUTTON1)
		{
			CreateKeyEvent(static_cast<int>(Crimson::eKey::MouseXButton1), false);
		}
		else
		{
			CreateKeyEvent(static_cast<int>(Crimson::eKey::MouseXButton2), false);
		}
		return true;
	}
	case WM_XBUTTONDBLCLK:
	{
		if (GET_XBUTTON_WPARAM(wParam) == XBUTTON1)
		{
			CreateDoubleClickEvent(static_cast<int>(Crimson::eKey::MouseXButton1));
		}
		else
		{
			CreateDoubleClickEvent(static_cast<int>(Crimson::eKey::MouseXButton2));
		}
		return true;
	}
	case WM_MOUSEMOVE:

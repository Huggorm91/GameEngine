...
public:
	...
	void EnqueueVoid(F&& aFunction, Args&&... someArgs);

	template<class F, class... Args>
	auto EnqueueFuture(F&& aFunction, Args&&... someArgs) -> std::future<typename std::invoke_result<F, Args...>::type>;
...
template<class F, class... Args>
void ThreadPool::EnqueueVoid(F&& aFunction, Args&&... someArgs)
{
...
template<class F, class... Args>
auto ThreadPool::EnqueueFuture(F&& aFunction, Args&&... someArgs)

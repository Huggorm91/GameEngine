...
public:
	...
	//LineHandle AddSquare(const CommonUtilities::Vector3f& aFrom, const CommonUtilities::Vector3f& aTo, float aHeadSize, const CommonUtilities::Vector4f& aColor = GetColor(eColor::White), const CommonUtilities::Matrix4x4f& aTransform = CommonUtilities::Matrix4x4f::Null, bool aIsUI = false, LineHandle* aHandle = nullptr);
	//LineHandle AddSquare(const CommonUtilities::Vector3f& aFrom, const CommonUtilities::Vector3f& aTo, float aHeadSize, const CommonUtilities::Vector4f& aColor = GetColor(eColor::White), const CommonUtilities::Matrix4x4f& aTransform = CommonUtilities::Matrix4x4f::Null, bool aIsUI = false, LineHandle* aHandle = nullptr);
	//LineHandle AddCircle(const CommonUtilities::Vector3f& aFrom, const CommonUtilities::Vector3f& aTo, float aHeadSize, const CommonUtilities::Vector4f& aColor = GetColor(eColor::White), const CommonUtilities::Matrix4x4f& aTransform = CommonUtilities::Matrix4x4f::Null, bool aIsUI = false, LineHandle* aHandle = nullptr);
	//LineHandle AddTriangle(const CommonUtilities::Vector3f& aFrom, const CommonUtilities::Vector3f& aTo, float aHeadSize, const CommonUtilities::Vector4f& aColor = GetColor(eColor::White), const CommonUtilities::Matrix4x4f& aTransform =CommonUtilities::Matrix4x4f::Null}, bool aIsUI = false, LineHandle* aHandle = nullptr);
	//LineHandle AddCube(const CommonUtilities::Vector3f& aFrom, const CommonUtilities::Vector3f& aTo, float aHeadSize, const CommonUtilities::Vector4f& aColor = GetColor(eColor::White), const CommonUtilities::Matrix4x4f& aTransform = CommonUtilities::Matrix4x4f::Null, bool aIsUI = false, LineHandle* aHandle = nullptr);
	//LineHandle AddCube(const CommonUtilities::Vector3f& aFrom, const CommonUtilities::Vector3f& aTo, float aHeadSize, const CommonUtilities::Vector4f& aColor = GetColor(eColor::White), const CommonUtilities::Matrix4x4f& aTransform = CommonUtilities::Matrix4x4f::Null, bool aIsUI = false, LineHandle* aHandle = nullptr);
	//LineHandle AddSphere(const CommonUtilities::Vector3f& aFrom, const CommonUtilities::Vector3f& aTo, float aHeadSize, const CommonUtilities::Vector4f& aColor = GetColor(eColor::White), const CommonUtilities::Matrix4x4f& aTransform = CommonUtilities::Matrix4x4f::Null, bool aIsUI = false, LineHandle* aHandle = nullptr);
	//LineHandle AddCylinder(const CommonUtilities::Vector3f& aFrom, const CommonUtilities::Vector3f& aTo, float aHeadSize, const CommonUtilities::Vector4f& aColor = GetColor(eColor::White), const CommonUtilities::Matrix4x4f& aTransform = CommonUtilities::Matrix4x4f::Null, bool aIsUI = false, LineHandle* aHandle = nullptr);
	//LineHandle AddCapsule(const CommonUtilities::Vector3f& aFrom, const CommonUtilities::Vector3f& aTo, float aHeadSize, const CommonUtilities::Vector4f& aColor = GetColor(eColor::White), const CommonUtilities::Matrix4x4f& aTransform = CommonUtilities::Matrix4x4f::Null, bool aIsUI = false, LineHandle* aHandle = nullptr);
	//LineHandle AddCone(const CommonUtilities::Vector3f& aFrom, const CommonUtilities::Vector3f& aTo, float aHeadSize, const CommonUtilities::Vector4f& aColor = GetColor(eColor::White), const CommonUtilities::Matrix4x4f& aTransform = CommonUtilities::Matrix4x4f::Null, bool aIsUI = false, LineHandle* aHandle = nullptr);

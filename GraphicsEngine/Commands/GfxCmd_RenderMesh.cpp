...
GfxCmd_RenderMesh::GfxCmd_RenderMesh(const MeshComponent& aMesh): myMeshElements(aMesh.GetElements()), myTransformMatrix(aMesh.GetTransform()), myColor(aMesh.GetColor()), myHasBones(false), myBoneTransforms()
#ifdef _DEBUG
...
GfxCmd_RenderMesh::GfxCmd_RenderMesh(const AnimatedMeshComponent& aMesh) : myMeshElements(aMesh.GetElements()), myTransformMatrix(aMesh.GetTransform()), myColor(aMesh.GetColor()), myHasBones(true), myBoneTransforms(aMesh.GetBoneTransforms())
#ifdef _DEBUG
, myMeshName(aMesh.GetName())
#endif // _DEBUG
{
